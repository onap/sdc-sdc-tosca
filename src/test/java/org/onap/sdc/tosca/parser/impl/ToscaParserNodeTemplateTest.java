...
import org.onap.sdc.tosca.parser.api.parameters.Annotation;
...
public class ToscaParserNodeTemplateTest extends SdcToscaParserBasicTest {
    ...
    public void testGetNodeTemplateCustomizationUuid() {
        ...
        for (NodeTemplate nt : serviceVfList) {
            if (nt.getName().equals("FDNT 1")) {
                found = true;
                assertEquals(fdntCsarHelper.getNodeTemplateCustomizationUuid(nt),
                    "56179cd8-de4a-4c38-919b-bbc4452d2d73");
            }
        }
        assertTrue(found);
    }
    ...
    public void testNodeTemplateFlatProperty() throws SdcToscaParserException {
        List<NodeTemplate> serviceVfList = fdntCsarHelper.getServiceVfList();
        assertEquals("2",
            fdntCsarHelper.getNodeTemplatePropertyLeafValue(serviceVfList.get(0), "availability_zone_max_count"));
        assertEquals("3", fdntCsarHelper.getNodeTemplatePropertyLeafValue(serviceVfList.get(0), "max_instances"));
        assertEquals("some code",
            fdntCsarHelper.getNodeTemplatePropertyLeafValue(serviceVfList.get(0), "nf_naming_code"));
    }
    ...
    public void testNodeTemplateFlatFunctionProperty() throws SdcToscaParserException {
        ...
        assertEquals(null,
            fdntCsarHelperWithInputs.getNodeTemplatePropertyLeafValue(serviceVfList.get(1), "target_network_role"));
    }
    ...
    public void testNodeTemplateNestedFunctionProperty() throws SdcToscaParserException {
        ...
        assertEquals(null, ipAssignCsarHelper
            .getNodeTemplatePropertyLeafValue(vfcs.get(0), "port_pd01_port_ip_requirements#ip_count_required#count"));
    }
    ...
    public void testNodeTemplateNestedProperty() throws SdcToscaParserException {
        ...
        assertEquals("24", fdntCsarHelper.getNodeTemplatePropertyLeafValue(nodeTemplate,
            "network_assignments#ipv4_subnet_default_assignment#cidr_mask"));
        assertEquals("7a6520b-9982354-ee82992c-105720",
            fdntCsarHelper.getNodeTemplatePropertyLeafValue(nodeTemplate, "network_flows#vpn_binding"));
    }
    ...
    public void testNodeTemplateNestedPropertyFromInput() throws SdcToscaParserException {
        ...
        //System.out.println("node template " + nodeTemplate.toString());
        assertEquals("true",
            fdntCsarHelper.getNodeTemplatePropertyLeafValue(nodeTemplate, "nf_naming#ecomp_generated_naming"));
        assertEquals("FDNT_instance_VF_2",
            fdntCsarHelper.getNodeTemplatePropertyLeafValue(nodeTemplate, "nf_naming#naming_policy"));
    }

    @Test
    public void testNodeTemplateNestedPropertyNotExists() throws SdcToscaParserException {
        List<NodeTemplate> serviceVfList = fdntCsarHelper.getServiceVfList();
        String nodeTemplatePropertyLeafValue = fdntCsarHelper
            .getNodeTemplatePropertyLeafValue(serviceVfList.get(0), "nf_role#nf_naming#kuku");
    ...
    public void testNodeTemplateFlatPropertyByNotFoundProperty() throws SdcToscaParserException {
        ...
        String nodeTemplatePropertyLeafValue = rainyCsarHelperMultiVfs
            .getNodeTemplatePropertyLeafValue(serviceVfList.get(0), "XXXX");
        assertNull(nodeTemplatePropertyLeafValue);
    }
    ...
    public void testNodeTemplateFlatPropertyByNullProperty() throws SdcToscaParserException {
        List<NodeTemplate> serviceVfList = rainyCsarHelperMultiVfs.getServiceVfList();
        String nodeTemplatePropertyLeafValue = rainyCsarHelperMultiVfs
            .getNodeTemplatePropertyLeafValue(serviceVfList.get(0), null);
        assertNull(nodeTemplatePropertyLeafValue);
    }
    ...
    public void testNodeTemplateFlatPropertyByNullNodeTemplate() throws SdcToscaParserException {
        String nodeTemplatePropertyLeafValue = rainyCsarHelperMultiVfs
            .getNodeTemplatePropertyLeafValue(null, "availability_zone_max_count");
        assertNull(nodeTemplatePropertyLeafValue);
    }
    //endregion
    ...
    public void testServiceNodeTemplatesByType() throws SdcToscaParserException {
        List<NodeTemplate> serviceVfList = fdntCsarHelper
            .getServiceNodeTemplatesByType("org.openecomp.resource.vf.Fdnt");
        assertNotNull(serviceVfList);
    ...
    public void testGetNodeTemplatePairsByReqName() {
        List<Pair<NodeTemplate, NodeTemplate>> nodeTemplatePairsByReqName = fdntCsarHelper
            .getNodeTemplatePairsByReqName(fdntCsarHelper.getCpListByVf(VF_CUSTOMIZATION_UUID),
                fdntCsarHelper.getVfcListByVf(VF_CUSTOMIZATION_UUID), "binding");
    ...
    public void testGetNodeTemplatePairsByReqNameWithNullReq() {
        List<Pair<NodeTemplate, NodeTemplate>> nodeTemplatePairsByReqName = fdntCsarHelper
            .getNodeTemplatePairsByReqName(
                fdntCsarHelper.getCpListByVf(VF_CUSTOMIZATION_UUID),
                fdntCsarHelper.getVfcListByVf(VF_CUSTOMIZATION_UUID), null);
        assertNotNull(nodeTemplatePairsByReqName);
        assertEquals(0, nodeTemplatePairsByReqName.size());
    }
    ...
    public void testGetNodeTemplatePairsByReqNameWithDummyReq() {
        ...
        List<Pair<NodeTemplate, NodeTemplate>> nodeTemplatePairsByReqName = fdntCsarHelper
            .getNodeTemplatePairsByReqName(
                fdntCsarHelper.getCpListByVf(VF_CUSTOMIZATION_UUID),
                fdntCsarHelper.getVfcListByVf(VF_CUSTOMIZATION_UUID), "XXX");
        assertNotNull(nodeTemplatePairsByReqName);
        assertEquals(0, nodeTemplatePairsByReqName.size());
    }
    //endregion
    ...
    public void testGetCpPropertiesFromVfc() {
        ...
        for (NodeTemplate vfc : vfcs) {
            ...
            if (vfc.getName().equalsIgnoreCase("abstract_pd_server")) {
                ...
                Map<String, Object> firstIpRequirements = (Map<String, Object>) ((List<Object>) pd01
                    .get("ip_requirements")).get(0);
                Map<String, Object> secondIpRequirements = (Map<String, Object>) ((List<Object>) pd01
                    .get("ip_requirements")).get(1);

                assertEquals("subnet_role_4", firstIpRequirements.get("subnet_role"));
                assertEquals(4, firstIpRequirements.get("ip_version"));
                assertEquals(true,
                    ((Map<String, Object>) firstIpRequirements.get("ip_count_required")).get("is_required"));
                assertEquals("get_input:node_count",
                    ((Map<String, Object>) firstIpRequirements.get("ip_count_required")).get("count").toString());
                assertEquals(false, ((Map<String, Object>) ((Map<String, Object>) pd01.get("mac_requirements"))
                    .get("mac_count_required")).get("is_required"));
    ...
    public void testGetNodeTemplatePropertyAsObject() {
        List<NodeTemplate> serviceVfList = fdntCsarHelper.getServiceVfList();
        assertEquals("2",
            fdntCsarHelper.getNodeTemplatePropertyValueAsObject(serviceVfList.get(0), "availability_zone_max_count"));
        assertEquals(3, fdntCsarHelper.getNodeTemplatePropertyValueAsObject(serviceVfList.get(0), "max_instances"));
        assertEquals("some code",
            fdntCsarHelper.getNodeTemplatePropertyValueAsObject(serviceVfList.get(0), "nf_naming_code"));
    }
    //endregion
    ...
    public void testFilterNodeTemplatePropertiesByContains() {
        ...
        for (NodeTemplate vfc : vfcs) {
            if (vfc.getName().equalsIgnoreCase("abstract_pd_server")) {
                isChecked = true;
                Map<String, String> filteredInputs = ipAssignCsarHelper
                    .filterNodeTemplatePropertiesByValue(vfc, FilterType.CONTAINS, "get_input");

                assertEquals(7, filteredInputs.size());
                assertEquals("get_input:availabilityzone_name",
                    filteredInputs.get("compute_pd_server_availability_zone"));
                assertEquals("get_input:[pd_server_names, 0]", filteredInputs.get("compute_pd_server_name"));
                assertEquals("get_input:node_count",
                    filteredInputs.get("port_pd01_port_ip_requirements#ip_count_required#count"));
    ...
    public void testFilterNodeTemplatePropertiesByDummyContains() {
        List<NodeTemplate> vfcs = ipAssignCsarHelper.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Map<String, String> filteredInputs = ipAssignCsarHelper
            .filterNodeTemplatePropertiesByValue(vfcs.get(0), FilterType.CONTAINS, "dummy");
    ...
    public void testFilterNodeTemplatePropertiesByEquals() {
        ...
        for (NodeTemplate vfc : vfcs) {
            if (vfc.getName().equalsIgnoreCase("abstract_pd_server")) {
                isChecked = true;
                Map<String, String> filteredInputs = ipAssignCsarHelper
                    .filterNodeTemplatePropertiesByValue(vfc, FilterType.EQUALS, "oam");
    ...
    public void testFilterNodeTemplatePropertiesByDummyEquals() {
        List<NodeTemplate> vfcs = ipAssignCsarHelper.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Map<String, String> filteredInputs = ipAssignCsarHelper
            .filterNodeTemplatePropertiesByValue(vfcs.get(0), FilterType.EQUALS, "dummy");
        assertNotNull(filteredInputs);
        assertEquals(0, filteredInputs.size());
    }
    ...
    public void testFilterNodeTemplatePropertiesByNullFilterType() {
        List<NodeTemplate> vfcs = ipAssignCsarHelper.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Map<String, String> filteredInputs = ipAssignCsarHelper
            .filterNodeTemplatePropertiesByValue(vfcs.get(0), null, "ddc");
        assertNotNull(filteredInputs);
        assertEquals(0, filteredInputs.size());
    }
    ...
    public void testFilterNodeTemplatePropertiesByNullPattern() {
        List<NodeTemplate> vfcs = ipAssignCsarHelper.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Map<String, String> filteredInputs = ipAssignCsarHelper
            .filterNodeTemplatePropertiesByValue(vfcs.get(0), FilterType.EQUALS, null);
        assertNotNull(filteredInputs);
        assertEquals(0, filteredInputs.size());
    }
    ...
    public void testFilterNodeTemplatePropertiesByNullVfc() {
        Map<String, String> filteredInputs = ipAssignCsarHelper
            .filterNodeTemplatePropertiesByValue(null, FilterType.EQUALS, "ddc");
        assertNotNull(filteredInputs);
        assertEquals(0, filteredInputs.size());
    }
    //endregion
    ...
    public void testGetVnfConfigGetProperties() {
        ...
        String manufacturer_reference_number = nfodCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#ATT_part_12345_for_FortiGate-VM00#vendor_info#manufacturer_reference_number");
        String num_cpus = nfodCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#ATT_part_67890_for_FortiGate-VM01#compute_flavor#num_cpus");
        String sp_part_number = nfodCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#ATT_part_67890_for_FortiGate-VM01#sp_part_number");
    ...
    public void testNewGetVnfConfigGetProperties() {
        ...
        //Deployment flavor 1
        String manufacturer_reference_number = nfodNEWCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#123456#vendor_info#manufacturer_reference_number");
        String num_cpus = nfodNEWCsarHlper
            .getNodeTemplatePropertyLeafValue(vnfConfig, "allowed_flavors#123456#compute_flavor#num_cpus");
        String sp_part_number = nfodNEWCsarHlper
            .getNodeTemplatePropertyLeafValue(vnfConfig, "allowed_flavors#123456#sp_part_number");
        ...
        //Deployment flavor 2
        manufacturer_reference_number = nfodNEWCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#FG_partNumbereJqQjUkteF1#vendor_info#manufacturer_reference_number");
        num_cpus = nfodNEWCsarHlper.getNodeTemplatePropertyLeafValue(vnfConfig,
            "allowed_flavors#FG_partNumbereJqQjUkteF1#compute_flavor#num_cpus");
        sp_part_number = nfodNEWCsarHlper
            .getNodeTemplatePropertyLeafValue(vnfConfig, "allowed_flavors#FG_partNumbereJqQjUkteF1#sp_part_number");
    ...
    public void testResolveGetInputForComplexTypeAndList() {
        ...
        Object propertyAsObject = resolveGetInputCsar
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "port_pd01_port_ip_requirements");
    ...
    public void testResolveGetInputForListOnNetworkCloud() {
        ...
        List<NodeTemplate> vfcListByVf = csarHelperServiceNetworkCloud
            .getVfcListByVf(csarHelperServiceNetworkCloud.getNodeTemplateCustomizationUuid(serviceVfList.get(0)));
    ...
    public void testResolveGetInputForPrimitiveTypeString() {
        ...
        List<NodeTemplate> vfcs = resolveGetInputCsar.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Object propertyAsObject = resolveGetInputCsar
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "port_pd01_port_network_role_tag");
    ...
    public void testResolveGetInputForPrimitiveTypeInteger() {
        ...
        List<NodeTemplate> vfcs = resolveGetInputCsar.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        String propertyAsObject = resolveGetInputCsar
            .getNodeTemplatePropertyLeafValue(vfcs.get(0), "port_pd01_port_order");
    ...
    public void testResolveGetInputForMap() {
        ...
        List<NodeTemplate> vfcs = resolveGetInputCsar.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Object propertyAsObject = resolveGetInputCsar
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "port_pd02_port_ip_requirements#ip_count_required");
    ...
    public void testResolveGetInputForComplexTypeAndListWithFalseValue() {
        ...
        Object propertyAsObject = resolveGetInputCsarFalse
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "port_pd01_port_ip_requirements");
        assertTrue(propertyAsObject instanceof ArrayList);
        assertEquals(2, ((ArrayList) propertyAsObject).size());
    ...
    public void testResolveGetInputForPrimitiveNullValue() {
        ...
        @SuppressWarnings("unchecked")
        List<String> propertyAsObject = (List<String>) resolveGetInputCsarQA
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "compute_pd_server_availability_zone");
    ...
    public void testResolveGetInputForPrimitiveIPValue() {
        List<NodeTemplate> vfcs = resolveGetInputCsarQA.getVfcListByVf("b5190df2-7880-4d6f-836f-56ab17e1b85b");
        Object propertyAsObject = resolveGetInputCsarQA
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "vm_image_name");
    ...
    public void getServiceNodeTemplateBySdcType_VF() {
        List<NodeTemplate> vfList = QAServiceForToscaParserTests
            .getServiceNodeTemplatesByType("org.openecomp.resource.vf.Vf1VPort1");
    ...
    public void testResolveGetInputArrayStructure() {
        ...
        propertyAsObject = resolveGetInputCsarQA
            .getNodeTemplatePropertyValueAsObject(vfcs.get(0), "port_pd01_port_ip_requirements");
        assertEquals(2, ((ArrayList) propertyAsObject).size());
    }
    ...
    public void testServiceCRInstanceProps() {
        ...
        assertEquals(crTemplate.getPropertyValue("nf_naming").toString(),
            ImmutableMap.of("ecomp_generated_naming", "true").toString());
    ...
    public void testGetPoliciesOfOriginOfNodeTemplateByToscaPolicyType() {
        NodeTemplate nt0 = csarHelperServicePolicy.getNodeTemplateByName("al_vf 0");
        NodeTemplate nt1 = csarHelperServicePolicy.getNodeTemplateByName("al_vf 1");
        List<Policy> policies = csarHelperServicePolicy
            .getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt0, "org.openecomp.policies.placement.Colocate");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);

        policies = csarHelperServicePolicy
            .getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt0, "org.openecomp.policies.placement.Antilocate");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);

        policies = csarHelperServicePolicy.getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt0,
            "org.openecomp.policies.placement.valet.Diversity");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);

        policies = csarHelperServicePolicy
            .getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt1, "org.openecomp.policies.placement.Colocate");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);

        policies = csarHelperServicePolicy
            .getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt1, "org.openecomp.policies.placement.Antilocate");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);

        policies = csarHelperServicePolicy.getPoliciesOfOriginOfNodeTemplateByToscaPolicyType(nt1,
            "org.openecomp.policies.placement.valet.Diversity");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);
    }
    ...
    public void testGetPolicyTargetNodeTemplatesFromOrigin() {
        List<NodeTemplate> nodeTemplates = csarHelperServicePolicy
            .getPolicyTargetsFromOrigin(csarHelperServicePolicy.getNodeTemplateByName("al_vf 1"),
                "policy..Colocate..0");
        assertNotNull(nodeTemplates);
    ...
    public void testGetPoliciesOfNodeTemplateByToscaPolicyType() {
        NodeTemplate nt0 = csarHelperVfPolicy.getNodeTemplateByName("al_vfc 1");
        List<Policy> policies = csarHelperVfPolicy
            .getPoliciesOfTargetByToscaPolicyType(nt0, "org.openecomp.policies.placement.Colocate");
        assertNotNull(policies);
        assertEquals(policies.size(), 1);
    }
    ...
    public void testGetPolicyTargetNodeTemplates() {
        List<NodeTemplate> nodeTemplates = csarHelperVfPolicy
            .getPolicyTargetsFromTopologyTemplate("policy..Colocate..0");
        assertNotNull(nodeTemplates);
        assertEquals(nodeTemplates.size(), 2);
    }
    ...
    public void testGetGroups() {
        ...
        groups = csarHelperServiceGroups
            .getGroupsOfOriginOfNodeTemplateByToscaGroupType(groupsVf, "org.openecomp.groups.VfcInstanceGroup");
        assertNotNull(groups);
        assertEquals(groups.size(), 1);

        groups = csarHelperServiceGroups
            .getGroupsOfOriginOfNodeTemplateByToscaGroupType(vlanGroups, "org.openecomp.groups.VfcInstanceGroup");
        assertNotNull(groups);
    ...
    public void getPropertyValueByNamePathAndNodeTypePathWhenPropertyValueIncludesGetInputAndPropertyHasDataType() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("exCP_naming",
    ...
    public void getPropertyValueByNamePathAndNodeTypePathWhenPropertyPathIsComplex() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("exCP_naming#ecomp_generated_naming",
                "vDBE 0#abstract_vdbe_1#vdbe_vdbe_untr_port");
    ...
    public void getPropertyValueByNamePathAndNodeTypePathWhenNoValueFoundForGetInputProperty() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath(
    ...
    public void getPropertyValueByNamePathAndNodeTemplatePathSuccess() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("is_default",
                "vDBE 0#abstract_vdbe_1#vdbe_vdbe_untr_port_nested2#vdbe_0_subint_oam_vmi_0");
        assertEquals(1, propertyValues.size());
    ...
    public void getPropertyValueByNamePathAndEmptyNodeTypePath() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath(null, "");
        assertEquals(0, propertyValues.size());
    }
    ...
    public void getPropertyValueByNamePathAndNullNodeTypePath() {
        List<String> propertyValues = csarHelperServiceGroupsInputs
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath(null, null);
        assertTrue(propertyValues.isEmpty());
    }

    @Test
    public void getPropertyValueByNamePathAndNodeTypePathForListOfGetInputs() {
        List<String> propertyValues = resolveGetInputCsar
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("port_pd01_port_ip_requirements#subnet_role",
    ...
    public void getPropertyValueByNamePathAndNodeTypePathForNetworkCloud() {
        List<String> propertyValues = csarHelperServiceNetworkCloud
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("related_networks#related_network_role",
    ...
    public void getPropertyValueByNamePathAndSingleNodeTypeNameForNetworkCloud() {
        List<String> propertyValues = csarHelperServiceNetworkCloud
            .getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath("nf_naming#ecomp_generated_naming",

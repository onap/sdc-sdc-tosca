...
public class ToscaParserReqAndCapTest extends SdcToscaParserBasicTest {
    ...
    public void testGetCapabilitiesOfNodeTemplate() {
        ...
        assertEquals(6,
            capabilityAssignments.getCapabilitiesByType("tosca.capabilities.network.Bindable").getAll().size());
    }
    ...
    public void testGetRequirementsOfNodeTemplate() {
        ...
        assertEquals("DNT_FW_RHRG",
            requirementAssignments.getRequirementsByName("binding").getAll().get(0).getNodeTemplateName());
    }
    ...
    public void testGetCapabilityPropertyLeafValue() {
        ...
        CapabilityAssignment capabilityAssignment = vf.getCapabilities()
            .getCapabilityByName("DNT_FW_RHRG.scalable_DNT_FW_SERVER");
    ...
    public void testGetCapabilityHierarchyPropertyLeafValue() {
        NodeTemplate vf = fdntCsarHelper.getServiceNodeTemplateByNodeName("FDNT 1");
        CapabilityAssignment capabilityAssignment = vf.getCapabilities()
            .getCapabilityByName("DNT_FW_RHRG.endpoint_DNT_FW_SERVER");
        assertNotNull(capabilityAssignment);
        String propValue = fdntCsarHelper
            .getCapabilityPropertyLeafValue(capabilityAssignment, "ports#entry_schema#type");
    ...
    public void getServiceNodeTemplateCapabilitiesOfTypeExVL() {
        List<NodeTemplate> serviceExtVlList = QAServiceForToscaParserTests
            .getServiceNodeTemplatesByType("org.openecomp.resource.vl.extVL");
        CapabilityAssignments capabilitiesOfExtVL = QAServiceForToscaParserTests
            .getCapabilitiesOf(serviceExtVlList.get(0));
    ...
    public void getServiceNodeTemplateCapabilitiesOfTypeVL() {
        List<NodeTemplate> serviceVlList = QAServiceForToscaParserTests
            .getServiceNodeTemplatesByType("tosca.nodes.network.Network");
...
//		RequirementAssignments requirementsByName = 
    ...
    public void getServiceNodeTemplateRequirementsOfTypeExVL() {
        List<NodeTemplate> serviceExtVlList = QAServiceForToscaParserTests
            .getServiceNodeTemplatesByType("org.openecomp.resource.vl.extVL");
        RequirementAssignments requirementsOfExtVL = QAServiceForToscaParserTests
            .getRequirementsOf(serviceExtVlList.get(0));
    ...
    public void testGetCapabilitiesByType() {
        ...
        assertNotNull(capabilityAssignments);
        CapabilityAssignments capabilitiesByType = capabilityAssignments
            .getCapabilitiesByType("tosca.capabilities.Scalable");
        int capsQty = capabilitiesByType.getAll().size();
        assertEquals(1, capsQty);
        CapabilityAssignment capabilityByName = capabilitiesByType
            .getCapabilityByName("abstract_pd_server.scalable_pd_server");
    ...
    public void testGetCapabilityByName() {
        ...
        CapabilityAssignments capabilityAssignments = resolveGetInputCsarQA.getCapabilitiesOf(vfs.get(0));
        assertNotNull(capabilityAssignments);
        CapabilityAssignment capabilityByName = capabilityAssignments
            .getCapabilityByName("abstract_pd_server.disk.iops_pd_server");
        assertNotNull(capabilityByName);
    ...
    public void testGetRequirementsByName() {
        ...
        assertEquals("DNT_FW_RHRG2",
            requirementAssignments.getRequirementsByName("binding").getAll().get(1).getNodeTemplateName());

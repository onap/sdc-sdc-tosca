...
import org.onap.sdc.tosca.parser.elements.PropertyDef;
import org.onap.sdc.tosca.parser.elements.constraints.Schema;
...
public class JToscaImportTest {
    ...
    public void testParseAnnotations() throws JToscaException {
        ...
        String fileStr = JToscaImportTest.class.getClassLoader()
            .getResource("csars/service-AdiodVmxVpeBvService-csar.csar").getFile();
        File file = new File(fileStr);
    ...
    public void testGetPropertyNameTest() throws JToscaException {
        ...
        ArrayList<String> valueList = (ArrayList<String>) nodeTemplate
            .getPropertyValueFromTemplatesByName("vmxvpfe_sriov41_0_port_vlanfilter");
...
*/
    ...
    public void testNullValueHasNoNullPointerException() throws JToscaException {
        ...
        String fileStr = JToscaImportTest.class.getClassLoader()
            .getResource("csars/service-JennyVtsbcKarunaSvc-csar.csar").getFile();
        File file = new File(fileStr);
        ToscaTemplate toscaTemplate = new ToscaTemplate(file.getAbsolutePath(), null, true, null);
        List<Input> inputs = toscaTemplate.getInputs();
        assertNotNull(inputs);
    ...
    public void testGetPolicyMetadata() throws JToscaException {
        String fileStr = JToscaImportTest.class.getClassLoader()
            .getResource("csars/service-NetworkCloudVnfServiceMock-csar.csar").getFile();
        File file = new File(fileStr);
        ToscaTemplate toscaTemplate = new ToscaTemplate(file.getAbsolutePath(), null, true, null);
        ...
        assertEquals("adf03496-bf87-43cf-b20a-450e47cb44bd",
            policies.get(0).getMetaData().getOrDefault("UUID", "").toString());
    ...
    public void testGetPolicyMetadataObj() throws JToscaException {
        ...
        assertNotNull(policies);
        assertEquals(1, policies.size());
        Assert.assertEquals("adf03496-bf87-43cf-b20a-450e47cb44bd",
            policies.get(0).getMetaDataObj().getAllProperties().getOrDefault("UUID", "").toString());
        assertTrue(
            policies.get(0).getMetaDataObj().getAllProperties().getOrDefault("name_test", "").toString().isEmpty());
    }
    ...
    public void testGetDataType() throws JToscaException {
        ...
        for (DataType dataType : dataTypes) {
            ...
            if (dataType.getType().equals(TEST_DATATYPE_TEST1)) {
                ...
                assertThat(property.getSchema().get(TEST_DATATYPE_PROPERTY_TYPE), CoreMatchers.is(Schema.STRING));
            }
            if (dataType.getType().equals(TEST_DATATYPE_TEST2)) {
                ...
                assertThat((LinkedHashMap<String, Object>) toscaTemplate.getTopologyTemplate().getCustomDefs()
                    .get(TEST_DATATYPE_TEST1), notNullValue());
                assertThat((LinkedHashMap<String, Object>) toscaTemplate.getTopologyTemplate().getCustomDefs()
                    .get(TEST_DATATYPE_TEST2), notNullValue());

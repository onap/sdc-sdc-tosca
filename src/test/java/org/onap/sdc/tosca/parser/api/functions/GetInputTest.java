...
import org.onap.sdc.tosca.parser.api.JToscaImportTest;
...
public class GetInputTest {
    ...
    public void validate() throws JToscaException {
        ...
        NodeTemplate nodeTemplate = toscaTemplate.getNodeTemplates().get(1).getSubMappingToscaTemplate()
            .getNodeTemplates().get(0);
        ...
        assertThat(property.getType(), CoreMatchers.is(Schema.STRING));

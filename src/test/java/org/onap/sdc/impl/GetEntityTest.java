...
public class GetEntityTest {
    ...
    public static void setUpClass() {
        try {
            helper = SdcToscaParserFactory.getInstance().getSdcCsarHelper("C:\\work\\ToscaParser\\getEntity\\csars\\service-JennyVtsbcVlanSvc-csar.csar");
    ...
    public void getCpEntityMock() {
        ...
        assertEquals(0, entities.get(0).getMemberNodes().size());
        ...
        assertEquals("1fdc9625-dfec-48e1-aaf8-7b92f78ca854", entities.get(0).getParentPath());

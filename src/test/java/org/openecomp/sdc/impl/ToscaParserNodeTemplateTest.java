...
public class ToscaParserNodeTemplateTest extends SdcToscaParserBasicTest {
	...
	/*public void testGetCRNodeTemplateInputs() {
		NodeTemplate crNodeTemplate = csarHelperServiceWithCrs.getServiceNodeTemplateByNodeName("chaya best cr 1");
		csarHelperServiceWithCrs.getNodeTemplatePropertyLeafValue(crNodeTemplate

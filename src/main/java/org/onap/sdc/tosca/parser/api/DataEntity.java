...
import org.onap.sdc.tosca.parser.elements.PortSpec;
import org.onap.sdc.tosca.parser.elements.PropertyDef;
import org.onap.sdc.tosca.parser.elements.ScalarUnitFrequency;
import org.onap.sdc.tosca.parser.elements.ScalarUnitSize;
import org.onap.sdc.tosca.parser.elements.ScalarUnitTime;
...
import org.onap.sdc.tosca.parser.utils.TOSCAVersionProperty;
import org.onap.sdc.tosca.parser.utils.ThreadLocalsHolder;
import org.onap.sdc.tosca.parser.utils.ValidateUtils;
        ...
        // If the datatype has 'properties' definition
            ...
            if (!(value instanceof LinkedHashMap)) {
                ...
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE001", String.format(
            ...
            for (String valueKey : valueDict.keySet()) {
                ...
                if (!("json").equals(dataType.getType()) && !allowedProps.contains(valueKey)) {
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE100", String.format(

...
public class EntityType {
    ...
    public static void updateDefinitions(String version) {
        ...
        try (InputStream input = EntityType.class.getClassLoader().getResourceAsStream(extensionDefsFile);) {
            ...
            log.error("EntityType - updateDefinitions - Failed to update definitions from defs file {}",
                extensionDefsFile);
                    ...
                    if (p.defs != null && p.defs.get(ndtype) != null) {
                        ...
                        if (value != null) {
                            if (value instanceof LinkedHashMap) {
                                for (Map.Entry<String, Object> me : ((LinkedHashMap<String, Object>) parentValue)
                                    .entrySet()) {
                                    String k = me.getKey();
...
import org.onap.sdc.tosca.parser.api.utils.yamlparser

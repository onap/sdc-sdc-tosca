...
public class GeneralUtility {
     ...
     * integer if str1 is _numerically_ greater than str2. The result is zero if the strings are _numerically_ equal. It
     * does not work if "1.10" is supposed to be equal to "1.10.0".
     */

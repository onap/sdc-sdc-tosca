...
public class Metadata {
    ...
    /**
     * Get all properties of a Metadata object.<br> This object represents the "metadata" section of some entity.
     *
     * @return all properties of this Metadata, as a key-value.
     */
    public Map<String, String> getAllProperties() {
        return metadataMap.entrySet().stream()
            .map(e -> new AbstractMap.SimpleEntry<String, String>(e.getKey(), String.valueOf(e.getValue())))

        ...
        for (String key : defs.keySet()) {
            ...
            if (!bFound) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE125", String.format(
    ...
    private void validateTargets(ArrayList<String> targetsList,
        ...
        for (String nodetype : targetsList) {
            if (customDef.get(nodetype) == null) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE126", String.format(
        ...
        for (String entrySchema : this.metaData.keySet()) {
            ...
            if (estob instanceof LinkedHashMap) {
                ...
                if (!est.equals("string")) {
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE128", String.format(

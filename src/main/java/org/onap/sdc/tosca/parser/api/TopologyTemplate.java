...
import org.onap.sdc.tosca.parser.api.functions.GetAttribute;
import org.onap.sdc.tosca.parser.api.functions.GetInput;
...
public class TopologyTemplate {
            ...
            if (memberNames != null) {
                ...
                if (memberNames.size() < 1 ||
                    ...
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE005", String.format(
    ...
    private void _validateGroupMembers(ArrayList<String> members) {
        ...
        for (String member : members) {
            if (!nodeNames.contains(member)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE239", String.format(
                        "InvalidGroupTargetException: Target member \"%s\" is not found in \"nodeTemplates\"",
                        member)));
            }
        }
    }
    ...
    private void _validateField() {
        for (String name : tpl.keySet()) {
            ...
            if (!bFound) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE240", String.format(

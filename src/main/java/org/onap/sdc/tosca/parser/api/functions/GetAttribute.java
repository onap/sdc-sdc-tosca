...
package org.onap.sdc.tosca.parser.api.functions;
...
import org.onap.sdc.tosca.parser.api.RelationshipTemplate;
...
import org.onap.sdc.tosca.parser.elements.AttributeDef;
        ...
        if (args.size() < 2) {
            ...
            if (attr != null) {
                ...
                if (!(args.get(1) instanceof String) || !(args.get(2) instanceof String)) {
                    ThreadLocalsHolder.getCollector().appendValidationIssue(new JToscaValidationIssue("JE146",
                        "ValueError: Illegal arguments for function \"get_attribute\". Expected a String argument"));
                }
                ...
                for (Object elem : args.subList(index, args.size())) {
                    if (valueType.equals("list")) {
                        if (!(elem instanceof Integer)) {
                            ThreadLocalsHolder
                                .getCollector().appendValidationIssue(new JToscaValidationIssue("JE147", String.format(
                        ...
                        if (bFound) {
                            ThreadLocalsHolder
                                .getCollector().appendValidationIssue(new JToscaValidationIssue("JE148", String.format(
                            ...
                            if (prop != null) {
                                ...
                                ThreadLocalsHolder
                                    .getCollector()
                                    .appendValidationIssue(new JToscaValidationIssue("JE149", String.format(
...
//							if(((ArrayList<String>)hostedOnRel.get("valid_target_types")).contains(capability.getType())) {
        ...
        if (nodeTemplateName.equals(HOST)) {
            ...
            if (nodeTpl == null) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE152", String.format(
    ...
    private AttributeDef _getCapabilityAttribute(NodeTemplate nodeTemplate,
        ...
        if (cap != null) {
            ...
            if (attribute == null) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE156", String.format(

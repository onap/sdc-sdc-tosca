...
import org.onap.sdc.tosca.parser.elements.ScalarUnit;
...
public abstract class Constraint {
        ...
        switch (constraintClass) {
            ...
            default:
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE102", String.format(
    ...
    public void validate(Object value) {
        ...
        if (!isValid(value)) {
            ThreadLocalsHolder
                .getCollector()
                .appendValidationIssue(new JToscaValidationIssue("JE008", "ValidationError: " + errMsg(value)));
        }
    }

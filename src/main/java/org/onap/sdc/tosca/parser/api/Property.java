...
import org.onap.sdc.tosca.parser.elements.constraints.Constraint;
...
public class Property {
    ...
    /**
     * Retrieves property value as list of strings if<br> - the value is simple<br> - the value is list of simple
     * values<br> - the provided path refers to a simple property inside a data type<br>
     *
     * @param propertyPath valid name of property for search.<br> If a name refers to a simple field inside a datatype,
     *                     the property name should be defined with # delimiter.<br>
     * @return List of property values. If not found, empty list will be returned.<br> If property value is a list
     * either of simple fields or of simple fields inside a datatype, all values from the list should be returned
     */
    ...
    private String getInternalPropertyType(String dataTypeName, String[] path, int index) {
        if (path.length > index) {
            ...
            if (complexProperty != null) {
                LinkedHashMap<String, Object> dataTypeProperties = (LinkedHashMap<String, Object>) complexProperty
                    .get(ENTRYPROPERTIES);
    ...
    private String getPropertyTypeFromCustomDefDeeply(String[] path, int index,

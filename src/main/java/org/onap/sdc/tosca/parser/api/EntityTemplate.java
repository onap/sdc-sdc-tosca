        ...
        if (_entityName.equals("policy_type")) {
            if (type == null) {
                ...
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE140", String.format(
...
//					LinkedHashMap relationship = rel instanceof LinkedHashMap ? (LinkedHashMap) rel : null;
    ...
    protected void _validateProperties(LinkedHashMap<String, Object> template, StatefulEntityType entityType) {
        @SuppressWarnings("unchecked")
        LinkedHashMap<String, Object> properties = (LinkedHashMap<String, Object>) entityType
            .getValue(PROPERTIES, template, false);
            ...
            for (Property prop : getCapability(cap).getPropertiesObjects()) {
                ...
                if (cap.equals("scalable") && prop.getName().equals("default_instances")) {
                    ...
                    if (defaultInstances < minInstances || defaultInstances > maxInstances) {
                        ...
                        //           self.name)
                        ThreadLocalsHolder
                            .getCollector().appendValidationIssue(new JToscaValidationIssue("JE141", String.format(
    ...
    private void _commonValidateProperties(StatefulEntityType entityType, LinkedHashMap<String, Object> properties) {
        ...
        if (properties != null) {
            ...
            if (!reqPropsNoValueOrDefault.isEmpty()) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE003", String.format(
            ...
            if (!requiredProps.isEmpty()) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE004", String.format(
    ...
    protected void _commonValidateField(LinkedHashMap<String, Object> schema, ArrayList<String> allowedList,
                                        String section) {
        for (String sname : schema.keySet()) {
            ...
            if (!bFound) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE144", String.format(
                        "UnknownFieldError: Section \"%s\" of template \"%s\" contains unknown field \"%s\"", section,
                        name, sname)));
            }
        }

...
public class RequirementAssignments {
    ...
    public RequirementAssignments(List<RequirementAssignment> requirementAssignments) {
        this.requirementAssignmentList =
            requirementAssignments != null ? new ArrayList<>(requirementAssignments) : new ArrayList<>();
    }

    /**
     * Get all requirement assignments for Node Template.<br> This object can be either the original one, holding all
     * requirement assignments for this node template,or a filtered one, holding a filtered subset.<br>
     *
     * @return list of requirement assignments for the node template. <br> If there are no requirement assignments,
     ...
     * @return RequirementAssignments object, containing requirement assignments of this type.<br> If no such found,

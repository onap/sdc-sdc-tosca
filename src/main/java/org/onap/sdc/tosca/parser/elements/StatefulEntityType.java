...
import org.onap.sdc.tosca.parser.api.UnsupportedType;
        ...
        if (UnsupportedType.validateType(entireEntityType)) {
            ...
            if (TOSCA_DEF.get(entireEntityType) != null) {
                ...
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE136", String.format(
        ...
        if (props != null) {
            for (Map.Entry<String, Object> me : props.entrySet()) {
                ...
                if (to == null || !(to instanceof LinkedHashMap)) {
                    ...
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE137", String.format(

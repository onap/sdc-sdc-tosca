...
class QueryProcessor {
    ...
    List<IEntityDetails> doQuery() {
        ...
        entityDetailsList.addAll(searchEntitiesInTopologyTemplates(foundTopologyTemplates));
    ...
    private List<IEntityDetails> searchEntitiesInTopologyTemplates(List<NodeTemplate> foundTopologyTemplates) {

        ...
        if (schema != null) {
            ...
            if (schema.get("type") == null) {
                ...
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE131", String.format(
    ...
    private void _loadRequiredAttrFromSchema() {
        ...
        if (val != null) {
            if (val instanceof Boolean) {
                ...
                //                                                  valid_values)
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE132", String.format(
    ...
    private void _loadStatusAttrFromSchema() {
        ...
        if (sts != null) {
            ...
            if (bFound) {
                ...
                //                                                  valid_values)
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE006", String.format(

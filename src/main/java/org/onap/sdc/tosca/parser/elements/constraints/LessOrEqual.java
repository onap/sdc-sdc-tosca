...
public class LessOrEqual extends Constraint {
    ...
    public LessOrEqual(String name, String type, Object c) {
        ...
        if (!validTypes.contains(constraintValue.getClass().getSimpleName())) {
            ThreadLocalsHolder.getCollector().appendValidationIssue(new JToscaValidationIssue("JE110",
                "InvalidSchemaError: The property \"less_or_equal\" expects comparable values"));
        }
    }

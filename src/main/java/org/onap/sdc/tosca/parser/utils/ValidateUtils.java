...
public class ValidateUtils {
        ...
        if (value != null) {
            if (!(value instanceof Number)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE257", String.format(
    ...
    public static Object validateInteger(Object value) {
        if (value != null) {
            if (!(value instanceof Integer)) {
                ...
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE258", String.format(
    ...
    public static Object validateFloat(Object value) {
        if (value != null) {
            if (!(value instanceof Float || value instanceof Double)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE259", String.format(
    ...
    public static Object validateString(Object value) {
        if (value != null) {
            if (!(value instanceof String)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE260", String.format(
    ...
    public static Object validateList(Object value) {
        if (value != null) {
            if (!(value instanceof ArrayList)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE261", String.format(
    ...
    public static Object validateRange(Object range) {
        ...
        if (!minTest && !maxTest) {
            ...
            if (min > max) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE264", String.format(
                        "ValueError:\"%s\" is not a valid range", range.toString())));
            }
        }
        return range;
    ...
    public static Object validateValueInRange(Object value, Object range, String propName) {
        ...
        if (!minTest && !maxTest) {
            ...
            if (min > max) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE268", String.format(
                        "ValueError:\"%s\" is not a valid range", range.toString())));
            }
        }
        // finally...
    ...
    public static Object validateMap(Object ob) {
        if (ob != null) {
            if (!(ob instanceof LinkedHashMap)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE270", String.format(
		...
		*/
        ...
        if (value != null) {
            if (!(value instanceof Date)) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE272", String.format(

...
public interface IEntityDetails {
    ...
    /**
     * Retrieves path to the searched entity instance in the model. It is based on the collection of the node templates
     * names delimited by #. The entity instance may exist in the service node templates, in the VF node templates or in
     * the nested of nested CVFC. The path will include the VF name, then the names of the CVFC recursively. If the
     * entity instance is located in the service directly, the path is empty string
     */
    String getPath();

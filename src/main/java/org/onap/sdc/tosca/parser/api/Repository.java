        ...
        if (reposit instanceof LinkedHashMap) {
            ...
            if (url == null) {
                ThreadLocalsHolder.getCollector()
                    .appendValidationIssue(new JToscaValidationIssue("JE229", String.format(
    ...
    private void loadAndValidate(String val, Object repositDef) {
        ...
        if (repositDef instanceof LinkedHashMap) {
            for (String key : ((LinkedHashMap<String, Object>) reposit).keySet()) {
                ...
                if (!bFound) {
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE230", String.format(
            ...
            if (repositUrl != null) {
                ...
                if (!urlVal) {
                    ThreadLocalsHolder.getCollector()
                        .appendValidationIssue(new JToscaValidationIssue("JE231", String.format(

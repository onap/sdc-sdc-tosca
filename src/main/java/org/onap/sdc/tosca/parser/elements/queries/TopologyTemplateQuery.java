...
public class TopologyTemplateQuery {
    ...
    public Boolean isMatchingSearchCriteria(NodeTemplate nodeTemplate) {
        ...
        isMatched = Objects.nonNull(nodeTemplate.getMetaData()) && isSearchedTemplate(nodeTemplate.getMetaData());
    ...
    public boolean isSameSdcType(Metadata metadata) {
        return Objects.nonNull(metadata) && sdcType.getValue().equals(metadata.getValue(SdcPropertyNames.PROPERTY_NAME_TYPE));
    }

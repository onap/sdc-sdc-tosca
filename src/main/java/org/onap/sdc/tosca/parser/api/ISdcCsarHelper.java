...
public interface ISdcCsarHelper {
    ...
    /**
     * Get any property leaf value for node template by full path separated by #.<br> For example, for node template
     * with this property:<br><br> network_assignments:<br> &nbsp;&nbsp;ecomp_generated_network_assignment: true<br>
     * &nbsp;&nbsp;is_shared_network: false<br> &nbsp;&nbsp;is_external_network: false<br>
     * &nbsp;&nbsp;ipv4_subnet_default_assignments:<br> &nbsp;&nbsp;&nbsp;&nbsp;use_ipv4: true<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;ip_network_address_plan: 1.2.3.4<br> &nbsp;&nbsp;&nbsp;&nbsp;dhcp_enabled: true<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;ip_version: 4<br> &nbsp;&nbsp;&nbsp;&nbsp;cidr_mask: 24<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;min_subnets_count: 1<br> &nbsp;&nbsp;ipv6_subnet_default_assignments:<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;use_ipv6: false<br><br>
     * <p>
     * calling<br> getNodeTemplatePropertyLeafValue(nodeTemplate, "network_assignments#ipv6_subnet_default_assignments#use_ipv6")<br>
     * will return "false".
     *
     ...
     * @param nodeTemplate            - nodeTemplate where the property should be looked up.
     * @param pathToPropertyLeafValue - the full path of the required property.
     * @return the leaf value as Object, or null if there's no such property. It's up to the caller to cast it to a
     * proper type.
     */
    @Deprecated
    ...
    /**
     * Get any property leaf value for a group definition by full path separated by #. Same logic as in {@link
     * #getNodeTemplatePropertyLeafValue(NodeTemplate, String) getNodeTemplatePropertyLeafValue}, only for a group.
     *
    ...
    /**
     * Get any property value for a group definition by full path separated by #. Same logic as in {@link
     * #getNodeTemplatePropertyLeafValue(NodeTemplate, String) getNodeTemplatePropertyLeafValue}, only for a group.
     *
     * @param group        - group where the property should be looked up.
     * @param propertyName - the name of the required property.
    ...
    /**
     * Get a property from a metadata object.<br> This is just sugaring method, same as calling
     * metadata.getMetadataPropertyValue(metadataPropertyName).<br>
     * <p>
     * For metadata object representing the below: <br><br>
     * <p>
     * metadata:<br> &nbsp;&nbsp;invariantUUID: 4598a404-00e1-42a6-8767-0bda343e2066<br> &nbsp;&nbsp;UUID:
     * e17940d6-42f8-4989-bad0-31de5addc619<br> &nbsp;&nbsp;customizationUUID: 83d086b2-a861-4d3b-aa84-3bfbb9b2ec20<br>
     * &nbsp;&nbsp;version: '0.1'<br> &nbsp;&nbsp;name: vIPR_ATM<br> &nbsp;&nbsp;description: vIPR_ATM<br>
     * &nbsp;&nbsp;type: VF<br> &nbsp;&nbsp;category: category1<br> &nbsp;&nbsp;subcategory: subCategory1<br><br>
     * <p>
     * calling<br> getMetadataPropertyValue(metadata,"invariantUUID")<br> will return
     * "4598a404-00e1-42a6-8767-0bda343e2066".
     *
    ...
    /**
     * Get input leaf value for the CSAR service, by full path separated by #.<br> Same logic as in {@link
     * #getNodeTemplatePropertyLeafValue(NodeTemplate, String) getNodeTemplatePropertyLeafValue}, only for an input full
     * path. The expected format is "input_name#default[optionally #rest_of_path]"
     *
     ...
     * For the below:<br><br>
     * <p>
     * substitution_mappings:<br> &nbsp;&nbsp;type: org.onap.services.ViprATM<br>
     * <p>
     * calling<br> getServiceSubstitutionMappingsTypeName()<br> will return "org.onap.services.ViprATM"
     *
    ...
    /**
     * Get service Metadata object.<br> This object represents the "metadata" section of a CSAR service.
     *
     ...
     * @deprecated This function is deprecated since its not tosca compliant. <br> Tosca defines the Metadata section as
     * map of string (not map of object).<br> This function is targeted to be removed as part of 1802.<br> Please use
     * {@link #getServiceMetadataAllProperties() getServiceMetadataAllProperties()}.
     */
    @Deprecated
     ...
     * <p>
     * ViprAtm..vIPR-ATM-Base..module-0:<br> &nbsp;&nbsp;type: org.onap.groups.VfModule<br>
     * &nbsp;&nbsp;.................<br> &nbsp;&nbsp;members: [vIPR_ATM_Ha_Two, vIPR_ATM_Ha_One, vIPR_ATM_OAM_SG,
     * vIPR_ATM_HA_TWO_SG, vIPR_ATM_HA_ONE_SG]<br><br>
     * <p>
     * calling<br> getMembersOfVfModule(NoteTemplate vfNodeTemplate, Group group)<br> will return List of the following
     * Node templates in the vfNodeTemplate: "vIPR_ATM_Ha_Two, vIPR_ATM_Ha_One, vIPR_ATM_OAM_SG, vIPR_ATM_HA_TWO_SG,
     * vIPR_ATM_HA_ONE_SG"<br>
     *
    ...
    /**
     * Get list of node template pairs, where for each pair,<br> the left node template in pair has requirement with
     * name reqName, <br> which should be satisfied with respective capability by the right node template in pair.<br>
     * <p>
     * For example, if we have the below two node templates in the vIPR VF:<br><br>
     * <p>
     * oam_extCP:<br> &nbsp;&nbsp;type: org.onap.resources.cp.extCP<br> &nbsp;&nbsp;requirements:<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;- virtualBinding: vipr_atm_firewall<br><br>
     * <p>
     * vipr_atm_firewall: <br> &nbsp;&nbsp;type: org.onap.resources.vfc.ViprAtm.abstract.nodes.heat.vipr_atm<br>
     * ........<br><br>
     * <p>
     * <p>
     * calling<br> getNodeTemplatePairsByReqName(getCpListByVf(viprCustomUuid), getVfcListByVf(viprCustomUuid),
     * "virtualBinding")<br> will return a list with one Pair - where left element of pair will be "oam_extCP" node
     * template,<br> and right element will be "vipr_atm_firewall" node template.<br>
     *
     * @param listOfReqNodeTemplates - list of node templates in which the "reqName" requirement should be looked.
     * @param listOfCapNodeTemplates - list of node templates in which the capability matching the "reqName" requirement
     *                               should be looked.
    ...
    /**
     * Get the conformance level of this CSAR. <br> The conformance level value of the CSAR is located in csar.meta file
     * at the top level of the CSAR file.<br> For 1707 CSARs, the conformance level is 3.0.
     *
    ...
    /**
     * Get the map of CP-related props from a VFC node template. <br> Let's say there are 5 CPs related to this VFC.
     * Then the output will look like this: <br><br> {port_fe1_sigtran={ip_requirements#ip_count_required#count=1,
     * ip_requirements#dhcp_enabled=true, ip_requirements#ip_version=4, subnetpoolid="subnet_1",
     * network_role_tag="SIGNET_vrf_B1_direct"},<br> port_fe_cluster={ip_requirements#ip_count_required#count=2,
     * ip_requirements#dhcp_enabled=true, ip_requirements#ip_version=4},<br> port_fe_slan={ip_requirements#ip_count_required#count=1,
     * ip_requirements#dhcp_enabled=true, ip_requirements#ip_version=4},<br> port_fe_interce={ip_requirements#ip_count_required#count=1,
     * ip_requirements#dhcp_enabled=true, ip_requirements#ip_version=4},<br> port_fe_oam={ip_requirements#ip_count_required#count=2,
     * ip_requirements#dhcp_enabled=true, ip_requirements#ip_version=4, subnetpoolid="subnet_2",
     * network_role_tag="Mobility_OAM_protected"}}<br><br>
     *
     * @param vfc - VFC node template to look for CP-related props.
     * @return map <b>CP node template name</b>  to a map of <b>full path to a property on this CP</b> - <b> value of
     * this property on this CP</b>.
     * @deprecated This function is deprecated since its flattened form doesn't provide solution for cp properties of
     * type List. Will be removed in 1802.
     */
    @Deprecated
    public Map<String, Map<String, Object>> getCpPropertiesFromVfc(NodeTemplate vfc);

    /**
     * Get the map of CP-related props from a VFC node template. <br> Let's say there are 2 CPs (ports) related to this
     * VFC. Then the output will look like this: <br><br> {port_fe_sigtran={ip_requirements={ip_count_required: {count:
     * 1}, dhcp_enabled: true, ip_version: 4}, subnetpoolid: "subnet_1", network_role_tag: "SIGNET_vrf_B1_direct"}<br>
    ...
    /**
     * Get node template Metadata object.<br> This object represents the "metadata" section of node template.
     *
    ...
    /**
     * Get CapabilityAssignments object for this node template.<br> This should be an entry point function for working
     * with capability assignments of node template.<br> This object allows filtering capability assignments
     * objects.<br>
     *
     * @param nt - Node Template to get its capability assignments.
     * @return CapabilitiesAssignments that contains list of capability assignments for the node template.<br> If none
    ...
    /**
     * Get RequirementAssignments object for this node template.<br> This should be an entry point function for working
     * with requirement assignments of node template.<br> This object allows filtering requirement assignments
     * objects.<br>
     *
     * @param nt - Node Template to get its requirement assignments.
     * @return RequirementAssignments that contains list of requirement assignments for the node template. If none
     * found, an empty list will be returned.
     */
    @Deprecated
    ...
    /**
     * Get any property leaf value for capability by full path separated by #. Same logic as in {@link
     * #getNodeTemplatePropertyLeafValue(NodeTemplate, String) getNodeTemplatePropertyLeafValue}, only for a capability
     * assignment.
     *
    ...
    /**
     * Get all the policies of the origin component (nested topology template) of the node template specified by policy
     * type
     *
     * @param nodeTemplate   the node template
     * @param policyTypeName the name of the policy type
    ...
    /**
     * Get all the node templates of the origin component (nested topology template) of node template, which are the
     * targets of the policy specified by name
     *
     * @param nodeTemplate the node template
     * @param policyName   the name of the policy
     * @return the list of the node templates
    ...
    /**
     * Get all groups of this of the origin component (nested topology template) of the node template by specified tosca
     * group type
     *
     * @param nodeTemplate the node template
     * @param groupType    the group type
    ...
    /**
     * Get members of the group belongs to the origin component (nested topology template) of the node template by group
     * name
     *
     * @param nodeTemplate the node template
     * @param groupName    the name of the group
     ...
     *
     * @return Map that contains the list of all interfaces and their definitions. If none found, an empty map will be
     * returned.
     */
     ...
     *
     * @return List that contains the name of all interfaces. If none found, an empty list will be returned.
     */
     ...
     *
     * @return List that contains the definitions of given interface name. If none found, an empty list will be
     * returned.
     */
     ...
     *
     * @return List that contains the name of all operations for a given node template and interface name. If none
     * found, an empty list will be returned.
     */
     ...
     *
     * @return InterfaceDef representing the operation details. If none found, null will be returned.
     */
     ...
     *
     * @param propertyNamePath valid name of property for search.<br> To find value in the datatype with datatype entry
     *                         schema, the property name should be defined with # delimiter
     * @param nodeTemplatePath path to the model node template that property value will be searched.<br> Path is based
     *                         on the collection of the node templates names delimited by #.
     * @return List of property values. If none found, empty list will be returned.
     */
    @Deprecated
    List<String> getPropertyLeafValueByPropertyNamePathAndNodeTemplatePath(String propertyNamePath,
                                                                           String nodeTemplatePath);

    boolean isNodeTypeSupported(NodeTemplate nodeTemplate);

    /**
     * Retrieves details of one or more entity templates according to provided query parameters from corresponding
     * topology template
     *
     * @param entityQuery           Object describing the searched entity parameters. Includes one of following
     *                              parameters: entity type, SDC (node template) type, tosca type as well as optional
     *                              customizationUUID and UUID
     * @param topologyTemplateQuery parameters of the topology template containing the above entity. Includes SDC type
     *                              of the container and optional customizationUUID
     * @param isRecursive           indicates if the search is recursive starting from the required topology template .
     * @return list of @{@link IEntityDetails} objects containing information about the found entities. If either no
     * entities found or the provided query is incorrect, an empty list is returned
     */
    List<IEntityDetails> getEntity(EntityQuery entityQuery, TopologyTemplateQuery topologyTemplateQuery,
                                   boolean isRecursive);

...
public class NodeTemplate extends EntityTemplate {
    ...
    public NodeTemplate(String name,
        ...
        metadata = _metaData();
        artifacts = readArtifacts((LinkedHashMap<String, Object>) templates.get(name));
    }

    private Map<String, ArtifactTypeDef> readArtifacts(final Map<String, Object> nodetemplate) {
